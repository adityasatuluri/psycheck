...
import '/components/mood_tracker_widget.dart';
...
class HomePage1Widget extends StatefulWidget {
  const HomePage1Widget({
    ...
    double? moodtrack,
    int? mood,
  })  : moodtrack = moodtrack ?? 0.0,
        mood = mood ?? 0;

  final double moodtrack;
  final int mood;
...
class _HomePage1WidgetState extends State<HomePage1Widget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.listmood = await actions.addList();
    });
      ...
      child: Scaffold(
        ...
        drawer: SizedBox(
          ...
          child: WebViewAware(
            ...
            elevation: 16.0,
            child: wrapWithModel(
              model: _model.altNavModel,
              updateCallback: () => setState(() {}),
              child: AltNavWidget(
                navOne: FlutterFlowTheme.of(context).primary,
              ),
            ),
          )),
        ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'wyoabws9' /* Below are you new notification... */,
                        ),
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '76al75gp' /* okay wow, you could definitely... */,
                                              ),
                                              style:
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '7141yjwd' /* okay wow, you could definitely... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium,
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'z1sw05l8' /* okay wow, you could definitely... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium,
        ...
        body: Padding(
          padding: const EdgeInsetsDirectional.fromSTEB(16.0, 10.0, 16.0, 70.0),
                                              ...
                                              Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 8.0, 0.0, 0.0),
                                                child: Text(
                                                  'STREAK:  ${FFAppState().streak.toString()}',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .displaySmall,
                                                ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          FFLocalizations.of(context).getText(
                            'oefwg8cb' /* View assessment scores */,
                          ),
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
                              .override(
                                              ...
                                              child: CircularPercentIndicator(
                                                ...
                                                backgroundColor:
                                                    FlutterFlowTheme.of(context)
                                                        .primary,
                                                center: Text(
                                                  '${FFAppState().totalscore.toString()} / 30',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .displaySmall
                                                      .override(
                        ...
                        children: [
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                context.pushNamed('PreAssessmentLanding1');
                              },
                              child: Container(
                                width: MediaQuery.sizeOf(context).width * 1.0,
                                decoration: BoxDecoration(
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '837jg0vd' /* Advised to take frequently */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodySmall
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  '8taw9mwq' /* Recommended Assessments */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .titleMedium
                                    .override(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  '2wr1qmbb' /* Generalized Anxiety Disorder 7... */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  '5z0hod06' /* Depression: Patient Health Que... */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall
