...
Future<String> chatGPTres(
  ...
  final data = {
    ...
    'model': "gpt-3.5-turbo-0613", // the GPT-3 model to be used
  };
  ...
  if (httpResponse.statusCode == 200) {
    ...
    //return httpResponse.reasonPhrase; // print the reason for the error
    return 'noresponse'; // return an empty string
  }
}
